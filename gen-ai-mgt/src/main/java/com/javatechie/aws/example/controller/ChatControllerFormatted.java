...
public class ChatControllerFormatted {
     ...
     */
    @GetMapping("/formatted-conversational-chat")
    public String chat() {
    	
    	//---------------- 1st prompt
    	String prompt1 = "Ameesha Patel earns 2000 AED per month. Bakdu Patel earns 10000 AED per year. Tanutanu Patel earns 10 percent commission on per completed deal. She has completed 10 deals this year worth total of 100000 AED. They all have applied for a loan. The bank can provide 1 loan only and to the person who total earnings per year is the highest. Who will be selected for the loan? Please gnerate the output in a presentable HTML format with table borders and bold headers and text in green. Highlight the name of the selected candidate in bold red";
