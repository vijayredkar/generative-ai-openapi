...
public class ChatControllerComplex {
     ...
     */
    @GetMapping("/complex-conversational-chat")
    public String chat() {
        ...
        //---------------- 2nd prompt        
        //String prompt2 = "Are you really sure?";
        String prompt2 = "To my previous question, "+ prompt1 + " your answer was " + responseText +" Are you really sure?";
        request = new ChatRequest(model, prompt2);
        System.out.println("\n\n ---- Make 2nd request : "+ request.toString());
        ...
        System.out.println("\n\n Got 2nd response : "+ responseText);


        
      //---------------- 3rd prompt
        /*
        String prompt3 = "I think you are wrong. Please recalculate";
        request = new ChatRequest(model, prompt3);
        System.out.println("\n\n ---- Make 3rd request : "+ request.toString());
        ...
        responseText = response.getChoices().get(0).getMessage().getContent();
        System.out.println("\n\n Got 3rd response : "+ responseText);
         */
      
        
      //---------------- 4th prompt
        /*
        //String prompt4 = "I forgot how much commission Tanutanu Patel got. Could you remind me?";
        String prompt4 = "What was my previous question?";
        request = new ChatRequest(model, prompt4);
        System.out.println("\n\n ---- Make 4th request : "+ request.toString());
